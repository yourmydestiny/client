...
const ResultPage = () => {
  ...
  const periodIndex =
    currentPeriod === 'current' ? 0 : currentPeriod === 'past' ? 1 : 2;
  ...
  return (
    <Container>
      <Header>
        <PastText currentPeriod={currentPeriod} onClick={changePast}>
          1980
        </PastText>
        <HeaderText currentPeriod={currentPeriod} onClick={changeCurrent}>
          {todayInfo.year}
        </HeaderText>
        <FutureText currentPeriod={currentPeriod} onClick={changeFuture}>
          2060
        </FutureText>
      </Header>
      <MainCoast>{`${
